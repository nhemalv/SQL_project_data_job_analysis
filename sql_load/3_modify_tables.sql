...
COPY company_dim
FROM 'C:\Users\nhemh\Desktop\SQL course\SQL_project_data_job_analysis\CSVs\company_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_dim
FROM 'C:\Users\nhemh\Desktop\SQL course\SQL_project_data_job_analysis\CSVs\skills_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY job_postings_fact
FROM 'C:\Users\nhemh\Desktop\SQL course\SQL_project_data_job_analysis\CSVs\job_postings_fact.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

COPY skills_job_dim
FROM 'C:\Users\nhemh\Desktop\SQL course\SQL_project_data_job_analysis\CSVs\skills_job_dim.csv'
WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
